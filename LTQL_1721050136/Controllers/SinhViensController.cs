...
namespace LTQL_1721050136.Controllers
{
    public class SinhViensController : Controller
    {
        ...
        {
            var sinhViens = db.SinhViens.Include(s => s.LopHoc136);
        ...
        {
            ViewBag.MaLop = new SelectList(db.LopHoc136s, "MaLop", "TenLop");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "MaSinhVien,HoTen,MaLop")] SinhVien sinhVien)
        {
            ...
            ViewBag.MaLop = new SelectList(db.LopHoc136s, "MaLop", "TenLop", sinhVien.MaLop);
            return View(sinhVien);
        }
